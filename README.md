...
**当前版本 v1.8.0「核心驾驶与战斗系统 2.0」**（Release 线：v1.7.2 手柄映射改键修复 → **v1.8.0 双摇杆炮塔独立瞄准 · 多锁导弹 · 惯性漂移 · 伤害管线 2.0**）

> 架构里程碑线（vNext-v3.x）：v14 高清 AI 立绘 → v15 俯视 16 向单位 + 地形图集 → v1.5 七主题关卡与玻璃 UI → v1.6 机动特效与 BOSS 护卫队 → v1.7 手感三改（震动分级 / 冲刺残影 / 3D 等离子护罩）→ v1.7.1 残影彗尾化
...
| 双摇杆战斗（触屏双虚拟摇杆） | 多锁导弹 · 六重叠锁准星 | 护盾弹反 · 蓝白粒子漩涡 |
|---|---|---|
| ![双摇杆](docs/img/v18-dualstick.jpg) | ![多锁](docs/img/v18-multilock.jpg) | ![漩涡](docs/img/v18-swirl.jpg) |

| 冰面漂移 · 履带拖印与喷雪 | 战地整备 · 五维培养（+冷却加速） | 帮助页 · 触屏可见按钮 |
|---|---|---|
| ![漂移](docs/img/v18-drift.jpg) | ![整备5行](docs/img/v18-upgrade5.jpg) | ![帮助触屏](docs/img/v18-help-touch.jpg) |

...
**当前版本 v1.7.2**（内容里程碑：v14 高清 AI 立绘 → v15 俯视 16 向单位 + 地形图集 → v1.5 七主题关卡与玻璃 UI → v1.6 机动特效与 BOSS 护卫队 → v1.7 手感三改：震动分级 · 冲刺残影 · 3D 等离子护罩 · 地形特效增强 → v1.7.1 残影彗尾化：随冲刺位移增长/卡住即消散 → v1.7.2 手柄映射改键修复：确认后按新键即改）

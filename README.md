...
当前版本：v1.3.3。双击 index.html 即可游玩（Chrome/Edge/Firefox/Safari，含手机浏览器）；HTML 单文件也会随 GitHub Release 发布为 `index.html`。GitHub Pages 在线版：https://rance1230.github.io/steel-roar-tank-battle/。
